...
import com.tasktrea.travel.databinding.ViewholderCategoryBinding;

import java.util.List;

public class CategoryAdapter extends RecyclerView.Adapter<CategoryAdapter.Viewholder> {
    private final List<Category> itmes;
    private int selectedPosition=-1;
    private int lastSelecedPosition=-1;
    private Context context;

    public CategoryAdapter(List<Category> itmes) {
        this.itmes = itmes;
    }
    ...
    public void onBindViewHolder(@NonNull CategoryAdapter.Viewholder holder, int position) {
        Category item = itmes.get(position);
        ...
        holder.binding.getRoot().setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View V) {
                lastSelecedPosition =selectedPosition;
                selectedPosition=position;
                notifyItemChanged(lastSelecedPosition);
        ...
        if(selectedPosition==position){
            ...
            holder.binding.pic.setBackgroundResource(R.drawable.blue_bg);
